...
if (isset($_POST['login_reg']) AND $_POST['pass_reg'] AND $_POST['email'] AND $_POST['name'] AND $_POST['surname'] AND $_POST['middle_name'] AND $_POST['date_birth'] AND $_POST['gender'] AND $_POST['hobbie'] AND $_POST['status'] AND $_POST['about']) {
